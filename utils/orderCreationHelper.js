...
function normalizeFieldsFromBody(body) {
  ...
  return {
    ...
    buildingNo: body.buildingNo != null ? String(body.buildingNo).trim() : '',
    apartmentNo: body.apartmentNo != null ? String(body.apartmentNo).trim() : '',
...
function buildOrderDocumentFromFields(userData, fields, orderNumber) {
  ...
  return new Order({
    ...
    orderCustomer: {
      ...
      buildingNo: fields.buildingNo || null,
      apartmentNo: fields.apartmentNo || null,
