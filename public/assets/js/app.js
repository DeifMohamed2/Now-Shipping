!(function () {
  ...
  function i() {
    ...
    if (n && ('twocolumn' == t || 'twocolumn' == n['data-layout'])) {
      ...
      if (
        ...
        var r = new SimpleBar(document.getElementById('navbar-nav'));
  ...
  function c(e) {
    if (e.target && e.target.matches('a.nav-link span'))
      if (0 == r(e.target.parentElement.nextElementSibling)) {
        ...
        1 == r(e.target.parentElement.nextElementSibling) &&
    ...
    if (e.target && e.target.matches('a.nav-link'))
      if (0 == r(e.target.nextElementSibling)) {
        ...
        1 == r(e.target.nextElementSibling) &&
        window.innerWidth >= 1848
      )
        for (
  ...
  !(function () {
    if (sessionStorage.getItem('defaultAttribute'))
      ((t = {})['data-layout'] = sessionStorage.getItem('data-layout')),
        ...
        (t['data-theme'] = sessionStorage.getItem('data-theme')),
        (t['data-theme-colors'] = sessionStorage.getItem('data-theme-colors')),
        f(t);
    else {
